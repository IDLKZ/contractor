        ...
        <form id="saveRequestForm" action="{{route("save-request")}}" enctype="multipart/form-data" method="post">
            ...
            <div class="row bg-white py-4 px-2">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group my-4">
                        ...
                        <input type="text" name="birthplace" class="form-control border-black-1" id="birthplace"
                               aria-describedby="birthplace" value="{{old("birthplace")}}">
                    ...
                    <div class="form-group my-4">
                        ...
                        <input type="text" name="iin" class="form-control border-black-1" id="iin"
                               aria-describedby="iin" value="{{old("iin")}}">
                        @if($errors->has('iin'))
                    ...
                    <div class="form-group my-4">
                        ...
                        <select class="form-control border-black-1" name="education" id="education">
                            ...
                            <option value="Неполное высшее образование – прикладной бакалавриат">Неполное высшее
                    ...
                    <div class="form-group my-4">
                        ...
                        <input type="text" name="position" class="form-control border-black-1" id="position"
                               aria-describedby="position" value="{{old("position")}}">
                    ...
                    <div class="form-group my-4">
                        ...
                        <input type="text" name="branch_name" class="form-control border-black-1" id="branch_name"
                               aria-describedby="branch_name" value="{{old("branch_name")}}">
                    ...
                    <div class="form-group my-4">
                        ...
                        <input type="text" name="year_service" class="form-control border-black-1" id="year_service"
                               aria-describedby="year_service" value="{{old("year_service")}}">
                ...
                <div class="col-md-12 table-responsive">
                    ...
                    <input type="text" id="anketa" hidden name="anketa[]" multiple >
                    <div>
                        <table class="table">
                            <thead>
                            <tr>
